import { RFMSegmentProvider } from '@/app/providers';
import { DashboardIds } from '@/common/types/DashboardIds';

import RFMDashboard from '../../rfm-elasticity/components/RFMDashboard';
...
export default function BaseDashboard({
  ...
  return (
    <BaseDashboardWrapper>
      <BaseDashboardHeader activeDashboard={activeDashboard} />
      <RFMDashboard />
    </BaseDashboardWrapper>
  );
}
